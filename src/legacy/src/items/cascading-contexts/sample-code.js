window.sampleCode = `// (Try scrolling)

// The below sample code is a lightly modified snippet of the
// Cookie Clicker source code (orteil.dashnet.org/cookieclicker/).
// It was chosen because it is highly nested and also
// because I like Cookie Clicker.
// The code is copyright Orteil.
...
Game.UpdateWrinklers = function () {
  ...
  for (var i in Game.wrinklers) {
    ...
    if (me.phase == 0 && Game.elderWrath > 0 && n < max && me.id < max) {
      ...
      if (Math.random() < chance) Game.SpawnWrinkler(me);
    }
